...
public class LibraryTest {
  ...
  public static void main(String[] args) {
    ...
    if (!lib.checkout(9781843190004L, "John Doe", 11, 1, 2019))
        System.err.println("TEST FAILED -- medium library: checkout");
    lib.checkout(9781843190011L, "John Doe", 11, 1, 2019);
    if (lib.checkout(9781843190011L, "John Doe", 11, 2, 2019))
        System.err.println("TEST FAILED -- medium library: checkout");
    ...
    lib.checkout(9781843190011L, "John Doe", 11, 1, 2019);
    lib.checkout(9781843190028L, "John Doe", 11, 1, 2019);
    if (lib.checkout(9781843190011L, "John Doe", 11, 2, 2019))
        System.err.println("TEST FAILED -- medium library: checkout");
    if (lib.checkout(9781843190028L, "John Doe", 11, 2, 2019))
        System.err.println("TEST FAILED -- medium library: checkout");
    lib.checkin("John Doe");
    if (!lib.checkout(9781843190011L, "Jane Doe", 11, 3, 2019))
        System.err.println("TEST FAILED -- medium library: checkout");
    if (!lib.checkout(9781843190028L, "Jane Doe", 11, 3, 2019))
        System.err.println("TEST FAILED -- medium library: checkout");
