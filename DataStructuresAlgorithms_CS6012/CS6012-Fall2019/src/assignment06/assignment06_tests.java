...
public class assignment06_tests {
	...
	public static void main(String[] args) {
		 ...
		 */
		ChainingHashTable cht = new ChainingHashTable(10, mhf);
		...
		cht.addAll(al);
		for (int i=0; i<10; i++) {
			System.out.println(cht.listSize(i));
		}
		...
		if(!cht.containsAll(al)) {
			System.err.println("ERROR TEST 9: Chek the add method or contains method. The set should contain test, but does not");
		}
		 ...
		 */
//		if(cht.add(null) == true) {
//			System.err.println("ERROR TEST 13: Check adding a null item");
//		}
	}
