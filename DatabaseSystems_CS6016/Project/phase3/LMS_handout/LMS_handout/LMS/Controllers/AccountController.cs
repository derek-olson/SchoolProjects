...
namespace LMS.Controllers
{
    ...
    public class AccountController : CommonController
    {
        ...
        public IActionResult Register(string returnUrl = null)
        {
            ...
            {
                depts.Add(new SelectListItem { Value = x.Dept, Text = x.Dept + ": " + x.Name });
            }
        ...
        {
            var check_exists = from u in db.Users where u.FirstName == fName && u.LastName == lName && u.Dob == DOB select u;
            if (check_exists.Count() == 0)
            {
                Random rand = new Random();
                var r = rand.Next(1000000, 9999999);
                var r_to_string = r.ToString("D7");
                var id = "u" + r_to_string;
                var check_id = from s in db.Users where s.UId == id select s.UId;
                while (check_id.Count() > 0)
                {
                    rand = new Random();
                    r = rand.Next(1000000, 9999999);
                    r_to_string = r.ToString("D7");
                    id = "u" + r_to_string;
                    check_id = from e in db.Users where e.UId == id select e.UId;
                }
                ...
                if (role == "Student")
                {
                    ...
                    students.StudentId = r;
                    students.UId = id;
                    students.Major = SubjectAbbrev;
                ...
                if (role == "Professor")
                {
                    ...
                    professors.ProfessorId = r;
                    professors.UId = id;
                    professors.Dept = SubjectAbbrev;
                ...
                if (role == "Administrator")
                {
                    ...
                    administrators.AdminId = r;
                    administrators.UId = id;
