...
//A NEW(AddExpr) class is constructed and an expression is returned.
...
//Helper function to parse let tokens. Returns LetExpr object.
static PTR(Expr) parse_let(std::istream &in){
    ...
    //contruct NEW(LetExpr) object and return it
    PTR(LetExpr) let_out = NEW(LetExpr)(var, expr1, expr2);
    return let_out;
}
...
//This function reads in an integer and returns a NumberExpr
static PTR(Expr) parse_number(std::istream &in) {
    int exp;
    in >> exp;
    return NEW(NumberExpr)(exp);
}
...
//The return is of the VariableExpr class, which inherets from Expr
...
//    PTR(Expr) ten_plus_one = NEW(AddExpr)(NEW(NumberExpr)(10), NEW(NumberExpr)(1));
//
...
//    CHECK( parse_str("10")->equals(NEW(NumberExpr)(10)) );
//    CHECK( parse_str("(10)")->equals(NEW(NumberExpr)(10)) );
//    CHECK( parse_str("10+1")->equals(ten_plus_one) );
//    CHECK( parse_str("(10+1)")->equals(ten_plus_one) );
//    CHECK( parse_str("(10)+1")->equals(ten_plus_one) );
//    CHECK( parse_str("10+(1)")->equals(ten_plus_one) );
//    CHECK( parse_str("1+2*3")->equals(NEW(AddExpr)(NEW(NumberExpr)(1),NEW(MultExpr)(NEW(NumberExpr)(2), NEW(NumberExpr)(3)))) );
//    CHECK( parse_str("1*2+3")->equals(NEW(AddExpr)(NEW(MultExpr)(NEW(NumberExpr)(1), NEW(NumberExpr)(2)),NEW(NumberExpr)(3))) );
//    CHECK( parse_str("4*2*3")->equals(NEW(MultExpr)(NEW(NumberExpr)(4),NEW(MultExpr)(NEW(NumberExpr)(2), NEW(NumberExpr)(3)))) );
//    CHECK( parse_str("4+2+3")->equals(NEW(AddExpr)(NEW(NumberExpr)(4),NEW(AddExpr)(NEW(NumberExpr)(2), NEW(NumberExpr)(3)))) );
//    CHECK( parse_str("4*(2+3)")->equals(NEW(MultExpr)(NEW(NumberExpr)(4),NEW(AddExpr)(NEW(NumberExpr)(2), NEW(NumberExpr)(3)))) );
//    CHECK( parse_str("(2+3)*4")->equals(NEW(MultExpr)(NEW(AddExpr)(NEW(NumberExpr)(2), NEW(NumberExpr)(3)),NEW(NumberExpr)(4))) );
//    CHECK( parse_str("xyz")->equals(NEW(VariableExpr)("xyz")) );
//    CHECK( parse_str("xyz+1")->equals(NEW(AddExpr)(NEW(VariableExpr)("xyz"), NEW(NumberExpr)(1))) );
//
...
//    CHECK( parse_str(" 10  + 1")->equals(ten_plus_one) );
//    CHECK( parse_str(" ( 10 + 1 ) ")->equals(ten_plus_one) );
//    CHECK( parse_str(" 11 * ( 10 + 1 ) ")->equals(NEW(MultExpr)(NEW(NumberExpr)(11),ten_plus_one)) );
//    CHECK( parse_str(" ( 11 * 10 ) + 1 ")->equals(NEW(AddExpr)(NEW(MultExpr)(NEW(NumberExpr)(11), NEW(NumberExpr)(10)),NEW(NumberExpr) (1))) );
//    CHECK( parse_str(" 1 + 2 * 3 ")->equals(NEW(AddExpr)(NEW(NumberExpr)(1),NEW(MultExpr)(NEW(NumberExpr)(2), NEW(NumberExpr)(3)))) );
//
...
//    CHECK( parse_str("_fun(x)(10)")->equals(NEW(FunExpr)("x", NEW(NumberExpr)(10))) );
//
...
//    CHECK( parse_str("_let x = 5 _in _let y = z + 2 _in x + y + (2 * 3)")->optimize()->equals(NEW(LetExpr)("y", NEW(AddExpr)(NEW(VariableExpr)("z"), NEW(NumberExpr)(2)),NEW(AddExpr)(NEW(NumberExpr)(5), NEW(AddExpr)(NEW(VariableExpr)("y"), NEW(NumberExpr)(6))))));
//    CHECK( parse_str("_let x = 7 _in _let x = x _in x")->optimize()->equals(NEW(NumberExpr)(7)));
//    CHECK( parse_str("_if _true _then _let y = 5 _in y + 3 _else _let y = 10 _in y + 3")->optimize()->equals(NEW(NumberExpr)(8)));
...
//    CHECK(parse_str("_fun(x)(10)")->optimize()->equals(NEW(FunExpr)("x", NEW(NumberExpr)(10))));
//    CHECK( parse_str("_if _true _then _let f = _fun(x) x + 1 _in f(10) _else _let f = _fun(x) x + 1 _in f(100)")->optimize()->equals(NEW(LetExpr)("f", NEW(FunExpr)("x", NEW(AddExpr)(NEW(VariableExpr)("x"), NEW(NumberExpr)(1))), NEW(CallExpr)(NEW(VariableExpr)("f"), NEW(NumberExpr)(10)))));
//    CHECK( parse_str("_if _false _then _let f = _fun(x) x + 1 _in f(10) _else _let f = _fun(x) x + 1 _in f(100)")->optimize()->equals(NEW(LetExpr)("f", NEW(FunExpr)("x", NEW(AddExpr)(NEW(VariableExpr)("x"), NEW(NumberExpr)(1))), NEW(CallExpr)(NEW(VariableExpr)("f"), NEW(NumberExpr)(100)))));
//    CHECK( parse_str("_if _false _then _let f = _fun(x) x + 1 _in f(10) _else _let f = _fun(x) x * 1 _in f(100)")->optimize()->equals(NEW(LetExpr)("f", NEW(FunExpr)("x", NEW(MultExpr)(NEW(VariableExpr)("x"), NEW(NumberExpr)(1))), NEW(CallExpr)(NEW(VariableExpr)("f"), NEW(NumberExpr)(100)))));
//    CHECK(!parse_str("_let x =5 _in x + y")->optimize()->equals(NEW(AddExpr)(NEW(NumberExpr)(5), NEW(VariableExpr)("5"))));
//}
