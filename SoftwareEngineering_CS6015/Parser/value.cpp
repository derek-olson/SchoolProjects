...
PTR(Val) NumVal::call(PTR(Val) actualArg){
    throw std::runtime_error("Invalid NumVal call \n");
}
...
void NumVal::call_step(PTR(Val) actual_arg_val, PTR(Cont) rest){
    throw std::runtime_error("No NumVal call step");
}
...
PTR(Val) BoolVal::call(PTR(Val) actualArg){
    throw std::runtime_error("Invalid BoolVal call \n");
}
...
void BoolVal::call_step(PTR(Val) actual_arg_val, PTR(Cont) rest){
    throw std::runtime_error("No BoolVal call step");
}
...
//    CHECK((NEW(FunVal)("x", NEW(NumberExpr)(10), NEW(EmptyEnv)()))->equals(NEW(FunVal)("x", NEW(NumberExpr)(10), NEW(EmptyEnv)())));
//}
//
//TEST_CASE("add_to") {
...
////    CHECK_THROWS_WITH ((NEW(FunVal)("x", NEW(NumberExpr)(10), NEW(EmptyEnv)()))->add_to(NEW(FunVal)("x", NEW(NumberExpr)(10000), NEW(EmptyEnv)())),"no adding functions");
//}
//
//TEST_CASE("mult_with") {
...
////    CHECK_THROWS_WITH((NEW(FunVal)("y", NEW(NumberExpr)(10), NEW(EmptyEnv)()))->mult_with(NEW(FunVal)("x", NEW(NumberExpr)(46), NEW(EmptyEnv)())),"no multiplying functions");
//}
//
//TEST_CASE("value to_expr") {
//    CHECK((NEW(NumVal)(5))->to_expr()->equals(NEW(NumberExpr)(5)));
//    CHECK(!(NEW(NumVal)(5))->to_expr()->equals(NEW(NumberExpr)(50)));
//    CHECK(!(NEW(NumVal)(5))->to_expr()->equals(NEW(VariableExpr)("five")));
...
//    CHECK((NEW(FunVal)("x",NEW(NumberExpr)(10), NEW(EmptyEnv)()))->to_expr()->equals(NEW(FunExpr)("x",NEW(NumberExpr)(10))));
//    CHECK(!(NEW(FunVal)("x",NEW(NumberExpr)(10), NEW(EmptyEnv)()))->to_expr()->equals(NEW(FunExpr)("x",NEW(NumberExpr)(1))));
//}
//
