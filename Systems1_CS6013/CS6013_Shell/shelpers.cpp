    ...
    for(int i = 0; i < ret.size(); ++i){
        ...
        for(int j = first + 1; j < last; ++j){
            if(tokens[j] == ">" || tokens[j] == "<" ){
                ...
                if(tokens[j] == ">"){
                   ...
                   //set the out to a file
                   ret[i].fdStdout = file;
                   break;
                }
                else if(tokens[j] == "<"){
                    //set the read to a file
                ...
                //set to allow background processing
        ...
        if(i > 0 && i < last){
            ...
            */
            ...
            //set the current command to the in of the fd
            ret[i].fdStdin = fd[0];
            //set the previous command to the out of the fd
